...
APP_NAME = osal_cache_test_multicore

SRCDIR      += $(PDK_OSAL_COMP_PATH)/test/src
# Local name of IPC test app
RPRC_PREFIX = osal_baremetal_cache_test
...
BIN_PATH_PREFIX_MACRO_LIST := $(foreach core, $(osal_baremetal_cache_test_$(SOC)_CORELIST), $(call BIN_PATH_PREFIX_RULE,$(core)))

$(eval ${BIN_PATH_PREFIX_MACRO_LIST})

CORES_IN_TEST = $(osal_baremetal_cache_test_$(SOC)_CORELIST)
...
MULTICORE_IMG_PARAMS += $(SBL_CORE_ID_mcu1_0) $(PDK_SCICLIENT_COMP_PATH)/tools/ccsLoadDmsc/$(SOC)/sciserver_testapp_freertos_mcu1_0_release.rprc
