...
/**
* Note: This file was auto-generated by TI PinMux on 4/18/2021 at 3:43:19 PM.
*
...
static pinmuxPerCfg_t gMybss_uarta_tx0PinCfg[] =
{
    /* MyBSS_UARTA_TX1 -> BSS_UARTA_TX -> M16 */
    {
        CSL_MSS_IOMUX_PADBL_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    {PINMUX_END}
};
static pinmuxModuleCfg_t gBss_uarta_txPinCfg[] =
{
    { 0, TRUE, gMybss_uarta_tx0PinCfg},
    {PINMUX_END}
};
       
static pinmuxPerCfg_t gMydss_uart0PinCfg[] =
{
    /* MyDSS_UART1 -> DSS_UARTA_TX -> A15 */
    {
        CSL_MSS_IOMUX_PADDC_CFG_REG, PIN_MODE(4) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyDSS_UART1 -> DSS_UARTA_RX -> B14 */
    {
...
{
    { 0, TRUE, gMydss_uart0PinCfg},
    {PINMUX_END}
};
       
static pinmuxPerCfg_t gMymss_epwm0PinCfg[] =
{
    /* MyMSS_EPWM1 -> MSS_EPWMA_0 -> E15 */
    {
        CSL_MSS_IOMUX_PADBP_CFG_REG, PIN_MODE(3) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_EPWM1 -> MSS_EPWMA_1 -> C18 */
    {
...
{
    /* MyMSS_I2C1 -> MSS_I2CA_SDA -> R8 */
    {
        CSL_MSS_IOMUX_PADBY_CFG_REG, PIN_MODE(3) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_I2C1 -> MSS_I2CA_SCL -> U9 */
    {
...
{
    /* MyMSS_MCAN1 -> MSS_MCANA_RX -> D16 */
    {
        CSL_MSS_IOMUX_PADBO_CFG_REG, PIN_MODE(4) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MCAN1 -> MSS_MCANA_TX -> D17 */
    {
...
{
    /* MyMSS_MCAN1 -> MSS_MCANB_RX -> A17 */
    {
        CSL_MSS_IOMUX_PADBS_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MCAN1 -> MSS_MCANB_TX -> B17 */
    {
...
{
    /* MyMSS_MDIO1 -> MSS_MDIO_DATA -> T5 */
    {
        CSL_MSS_IOMUX_PADCM_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MDIO1 -> MSS_MDIO_CLK -> R4 */
    {
...
{
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIA_HOSTIRQ -> V17 */
    {
        CSL_MSS_IOMUX_PADCS_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIA_MOSI -> U15 */
    {
        CSL_MSS_IOMUX_PADCO_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIA_MISO -> U16 */
    {
        CSL_MSS_IOMUX_PADCP_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIA_CLK -> T16 */
    {
        CSL_MSS_IOMUX_PADCQ_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIA_CS0 -> T15 */
    {
...
{
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_CS1 -> V16 */
    {
        CSL_MSS_IOMUX_PADAA_CFG_REG, PIN_MODE(6) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_CS2 -> R14 */
    {
        CSL_MSS_IOMUX_PADBC_CFG_REG, PIN_MODE(11) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_MOSI -> V12 */
    {
        CSL_MSS_IOMUX_PADAH_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_MISO -> U13 */
    {
        CSL_MSS_IOMUX_PADAI_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_CLK -> T13 */
    {
        CSL_MSS_IOMUX_PADAJ_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_MIBSPI1 -> MSS_MIBSPIB_CS0 -> U14 */
    {
...
{
    /* MyMSS_RS2321 -> MSS_RS232_RX -> F16 */
    {
        CSL_MSS_IOMUX_PADBD_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_RS2321 -> MSS_RS232_TX -> E17 */
    {
...
{
    /* MyMSS_UART1 -> MSS_UARTA_RX -> B16 */
    {
        CSL_MSS_IOMUX_PADDA_CFG_REG, PIN_MODE(5) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyMSS_UART1 -> MSS_UARTA_TX -> C16 */
    {
...
static pinmuxPerCfg_t gMymss_uart1PinCfg[] =
{
    /* MyMSS_UART1 -> MSS_UARTB_TX -> A14 */
    {
...
static pinmuxModuleCfg_t gMss_uartPinCfg[] =
{
    ...
    { 1, TRUE, gMymss_uart1PinCfg},
    {PINMUX_END}
};
       
static pinmuxPerCfg_t gMymss_gpio0PinCfg[] =
{
    /* MyMSS_GPIO1 -> MSS_GPIO13 -> B15 */
    {
...
{
    /* MyMSS_GPIO1 -> MSS_GPIO11 -> J15 */
    {
        CSL_MSS_IOMUX_PADBM_CFG_REG, PIN_MODE(7) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    {PINMUX_END}
};
...
{
    /* MyMSS_GPIO1 -> MSS_GPIO0 -> P17 */
    {
        CSL_MSS_IOMUX_PADBG_CFG_REG, PIN_MODE(6) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    {PINMUX_END}
};
...
{
    /* MyMSS_GPIO1 -> MSS_GPIO31 -> U17 */
    {
        CSL_MSS_IOMUX_PADBF_CFG_REG, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    {PINMUX_END}
};
...
{
    /* MyERROR1 -> WARM_RESET -> B12 */
    {
        CSL_MSS_IOMUX_PADAS_CFG_REG, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyERROR1 -> NERROR_OUT -> C11 */
    {
...
{
    /* MyPMIC_CLKOUT1 -> PMIC_CLKOUT -> T17 */
    {
...
pinmuxBoardCfg_t gAWR294XPinmuxData[] =
{
    ...
    {12, gErrorPinCfg},
    {13, gJtagPinCfg},
    {14, gMcu_clkoutPinCfg},
    {15, gPmic_clkoutPinCfg},
    {16, gXref_clk0PinCfg},
    {17, gXref_clk1PinCfg},
    {PINMUX_END}
};
