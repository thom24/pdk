...
_ti_sysbios_family_c64p_Hwi_Module__state__V .tag ti_sysbios_family_c64p_Hwi_Module_State__
...
||      mvkh    _ti_sysbios_family_c64p_Hwi_Module__state__V, a0
        ...
        ldw     *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP), b0
        ldw     *a0(ti_sysbios_family_c64p_Hwi_Module_State__.isrStack), b1
        b       a4                          ; call func()
        mvkl    funcReturn, b3
        mvkh    funcReturn, b3
        ; save old SP
  [!b0] stw     SP, *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP)
...
_ti_sysbios_family_c64p_Hwi_switchAndDispatch__I
        ...
        mvkl    _ti_sysbios_family_c64p_Hwi_Module__state__V, a0
        mvkh    _ti_sysbios_family_c64p_Hwi_Module__state__V, a0
        ldw     *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP), b0   ; get current taskSP value
        ldw     *a0(ti_sysbios_family_c64p_Hwi_Module_State__.isrStack), b1
        mvkl    _ti_sysbios_family_c64p_Hwi_dispatchCore__I, a1
        mvkh    _ti_sysbios_family_c64p_Hwi_dispatchCore__I, a1
        b       a1
  [!b0] stw     SP, *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP)   ; save old SP
...
dispatch_return:
  ...
  [!b0] ldw     *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP), b1   ; get current taskSP value
        b       b3
        ldw *++SP[2], b10   ; restore b10 from the stack
        nop     2
  [!b0] mv  b1, SP          ; set SP = taskSP
  [!b0] stw a1, *a0(ti_sysbios_family_c64p_Hwi_Module_State__.taskSP) ; taskSP = 0
