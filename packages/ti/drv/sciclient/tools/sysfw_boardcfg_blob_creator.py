...
#
# Use this script to combine System Firmware board configuration data
# used by the combined ROM image format. This is currently utilized to
# create the combined-tifs-cfg and the combined-dm-cfg for the combined
# ROM image but can be used to create other combinations of board
# configuration data.
