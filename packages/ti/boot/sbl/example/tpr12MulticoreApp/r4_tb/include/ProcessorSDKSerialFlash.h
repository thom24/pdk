...
/* Test bench image definition */
#define TB_FLASHIMAGE_LENGTH_ADDR       (0x08004000U)
#define TB_FLASHIMAGE_OFFSET_ADDR       (0x08004004U)
#define TB_FLASHIMAGE_ADDR              (0x08004008U)
...
#define MAX_SUPPORTED_BAUDRATE  BAUDRATE_115200
