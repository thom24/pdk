...
APP_NAME = sbl_boot_test_ordered
BUILD_OS_TYPE = baremetal
LOCAL_APP_NAME = sbl_$(BUILD_OS_TYPE)_boot_test_ordered_$(BOARD)_$(CORE)TestApp
...
SRCS_COMMON += sbl_amp_multicore_ordered.c sbl_printf.c
